    ...
    with open("./data/styles.txt") as file:
        for line in file.readlines():
            ...
            button = ctk.CTkButton(
                button_frame,
                text=line.strip(), corner_radius=100, command=lambda line=line: textbox_manager.write_text(textbox, line), compound="top", fg_color="transparent", hover_color="grey", text_color="#F0F0F0" if ctk.get_appearance_mode() == "Dark" else "#2E2E2E",
                image=ctk.CTkImage(
                    Image.open(
